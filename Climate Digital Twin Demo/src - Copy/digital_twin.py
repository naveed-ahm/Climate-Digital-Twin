...
import numpy as np
from src.config import GRID_SIZE, FEATURES, REGIONS, latlon_to_grid, grid_to_latlon

class ClimateDigitalTwin:
    def __init__(self, history_len=10):
        self.history_len = history_len
        # Initial state tensor: [history_steps, GRID_SIZE, GRID_SIZE, num_features]
        self.state_history = []
        self.current_step = -1
